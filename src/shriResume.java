...
public class shriResume {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://shriresume.com");
		  ...
		  //driver.manage().window().maximize();
		  //Begin My Resume
		  //driver.findElement(By.xpath("/html/body/div[4]/div/div[2]/div[1]/a[1]")).click();
		  //-----Font Size of button
		  String size= driver.findElement(By.className("org_br_btn")).getCssValue("font-size");
		 ...
		 //driver.findElements(By.tagName("a"));
		  ...
		  submit.click();
		  //Dashboard Page
		 WebElement resume = driver.findElement(By.xpath("//a[@href='/resumes/new']")); 
		 resume.click();
		 //Select Template
		 WebElement tem = driver.findElement(By.className("template2"));
		 tem.click();
		 //Resume name and Profile
		 ...
		 jse8.executeScript("scroll(0, 410);");
		 
		 driver.findElement(By.cssSelector(".radio.great")).click();
		 System.out.println("Error found:col1 ");
		 ...
		 System.out.println("Error found:col2 ");
		 driver.switchTo().frame(iFrame6);
		 System.out.println("Error found:col3 ");
		 Thread.sleep(2000);
		 ...
		 System.out.println("Error found:col4");
		 driver.switchTo().defaultContent();
		 
		 //driver.findElement(By.id("resume_awards_honor_attributes_col_select_columns_2")).click();
		 WebElement iFramee=driver.findElement(By.xpath("//iframe[@title='Rich Text Editor, resume_awards_honor_attributes_second_second_col']"));
	     ...
	     project_labeldesc.sendKeys("Description of Label of Project");
		 ...
		 while(i1.hasNext())
		{
			 ...
			 Thread.sleep(3000);
			 driver.findElement(By.name("resume[personal_information_attributes][avatar]")).sendKeys("E:\\sumr_trm\\sftwr_testing\\images\\neha.jpg");
		     Thread.sleep(3000);
	     ...
	     Thread.sleep(3000);
	     WebElement passport_no = driver.findElement(By.id("resume_personal_information_attributes_passport_number"));
	     passport_no.sendKeys("LPQRT12345");
		 ...
		 while(i2.hasNext())
		{
			 ...
			 jse18.executeScript("scroll(0, 380);");	 
			 Thread.sleep(3000);
		 ...
		 while(i3.hasNext())
		{
			 ...
			 jse19.executeScript("scroll(0, 280);");	 
			 Thread.sleep(3000);
